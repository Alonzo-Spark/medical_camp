      ...
      {data && (
        ...
        <div className="col-span-12 flex flex-col gap-6 md:flex-row md:items-center justify-between bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="h-16 w-16 rounded-2xl bg-teal-600 flex items-center justify-center text-3xl font-black text-white shadow-lg shadow-teal-200 flex-shrink-0">
              {patientId}
            </div>
            <div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-teal-50 text-teal-600 border border-teal-200 rounded-xl text-xs font-black uppercase tracking-wider hover:bg-teal-100 transition-all active:scale-[0.98] w-full md:w-auto"
          >
            ...
            <div className="flex border-b border-slate-100 bg-white">
              {['vitals', 'medicines', 'tests'].map((tab) => (
                <button
                  ...
                  className={`flex-1 py-4 text-[10px] font-black uppercase tracking-[0.2em] transition-all border-b-2 ${modalTab === tab
                  ...
                  <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                      {allTests.map(test => (
                        <label
                          key={test.id}
                          className={`flex items-center gap-3 px-4 py-3 rounded-xl border cursor-pointer transition-all ${visitData.selected_tests.includes(test.test_id)
                        ...
                        >
                          ...
                          />
                          <div className={`w-4 h-4 rounded border flex items-center justify-center transition-all ${visitData.selected_tests.includes(test.test_id) ? 'bg-purple-600 border-purple-600' : 'border-slate-300'
                            }`}>
